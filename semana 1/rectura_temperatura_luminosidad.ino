...
// se agrega variable con el puerto que permite leer los datos luminicos
#define LUMINOSIDAD_SENSOR_PIN  A0 
...
const char ssid[] = "MALDONADO DELGADO";
//Contraseña de la red Wifi
const char pass[] = "KD649666";

//Usuario uniandes sin @uniandes.edu.co
#define HOSTNAME "k.maldonadod"

//Conexión a Mosquitto
const char MQTT_HOST[] = "iotlab.virtual.uniandes.edu.co";
const int MQTT_PORT = 8082;
//Usuario uniandes sin @uniandes.edu.co
const char MQTT_USER[] = "k.maldonadod";
//Contraseña de MQTT que recibió por correo
const char MQTT_PASS[] = "202213221";
...
//Se agrega nuevo tópico al que se enviarán los datos de la intensidad luminica
...
void loop()
{
  ...
  // linea de codigo que pemrite leer las variables de luminosidad
  int valor_luminosidad = analogRead(LUMINOSIDAD_SENSOR_PIN); 
  ...
  //se crea un nuevo payload con el valor de la luminosidad para ser transimita 
  json = "{\"value\": "+ String(valor_luminosidad) + "}";
  ...
  if ( !isnan(h) && !isnan(t) &&  !isnan(valor_luminosidad)) {
    ...
    client.publish(MQTT_PUB_TOPIC2, payload2, false);
     //Publica en el tópico de la intencidad luminicia
